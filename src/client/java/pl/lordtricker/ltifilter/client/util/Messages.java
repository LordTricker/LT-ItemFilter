...
public class Messages {
    ...
    static {
        try (InputStream in = Messages.class.getResourceAsStream("/assets/ltifilter/messages/messages.json")) {
            if (in == null) {
    ...
    /**
     * Formatuje komunikat, zastępując placeholdery wartościami z mapy.
     */
